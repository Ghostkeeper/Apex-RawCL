...
area_t SimplePolygonTestGroper::area_opencl(const Device<>& device) const {
...
bool SimplePolygonTestGroper::contains_opencl(const Device<>& device, const Point2& point, const EdgeInclusion& include_edge, const FillType& fill_type) const {
